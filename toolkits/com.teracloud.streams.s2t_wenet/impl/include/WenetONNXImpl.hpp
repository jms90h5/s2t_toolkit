#ifndef WENET_ONNX_IMPL_HPP
#define WENET_ONNX_IMPL_HPP
...
/**
 * ONNX-based WeNet implementation
 * Uses ONNX Runtime instead of WeNet C API for maximum portability
 */
class WenetONNXImpl {
public:
    struct Config {
    ...
    explicit WenetONNXImpl(const Config& config);
    ~WenetONNXImpl();
