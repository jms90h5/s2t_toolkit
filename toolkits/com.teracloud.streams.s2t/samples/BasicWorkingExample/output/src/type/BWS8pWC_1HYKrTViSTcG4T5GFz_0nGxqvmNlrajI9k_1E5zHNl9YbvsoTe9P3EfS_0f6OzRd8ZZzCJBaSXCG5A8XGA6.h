// t2B5audioU14audioTimestamp


#ifndef BWS8PWC_1HYKRTVISTCG4T5GFZ_0NGXQVMNLRAJI9K_1E5ZHNL9YBVSOTE9P3EFS_0F6OZRD8ZZZCJBASXCG5A8XGA6_H_
#define BWS8PWC_1HYKRTVISTCG4T5GFZ_0NGXQVMNLRAJI9K_1E5ZHNL9YBVSOTE9P3EFS_0F6OZRD8ZZZCJBASXCG5A8XGA6_H_
...
#define SELF BWS8pWC_1HYKrTViSTcG4T5GFz_0nGxqvmNlrajI9k_1E5zHNl9YbvsoTe9P3EfS_0f6OzRd8ZZzCJBaSXCG5A8XGA6
...
public:
    ...
    typedef SPL::blob audio_type;
    typedef SPL::uint64 audioTimestamp_type;

    enum { num_attributes = 2 } ;
    
    SELF() : Tuple(), audio_(), audioTimestamp_() {}
    SELF(const Self & ot) : Tuple(), audio_(ot.audio_), audioTimestamp_(ot.audioTimestamp_) 
      { constructPayload(ot); }
    SELF(const audio_type & _audio, const audioTimestamp_type & _audioTimestamp) : Tuple(), audio_(_audio), audioTimestamp_(_audioTimestamp) { }
    ...
    audio_type & get_audio() { return audio_; }
    const audio_type & get_audio() const { return audio_; }
    void set_audio(const audio_type & _audio) { audio_ = _audio; }
    ...
    {
        size_t s = 17;
        s = 37 * s + std::hash<audio_type >()(audio_);
...
#undef SELF
#endif // BWS8PWC_1HYKRTVISTCG4T5GFZ_0NGXQVMNLRAJI9K_1E5ZHNL9YBVSOTE9P3EFS_0F6OZRD8ZZZCJBASXCG5A8XGA6_H_ 
