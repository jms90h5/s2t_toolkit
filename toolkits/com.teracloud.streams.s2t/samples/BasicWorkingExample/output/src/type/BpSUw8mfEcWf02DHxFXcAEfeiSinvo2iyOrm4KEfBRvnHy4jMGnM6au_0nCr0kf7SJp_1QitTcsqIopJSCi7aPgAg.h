// t4s4textb7isFinalF10confidenceU14audioTimestamp


#ifndef BPSUW8MFECWF02DHXFXCAEFEISINVO2IYORM4KEFBRVNHY4JMGNM6AU_0NCR0KF7SJP_1QITTCSQIOPJSCI7APGAG_H_
#define BPSUW8MFECWF02DHXFXCAEFEISINVO2IYORM4KEFBRVNHY4JMGNM6AU_0NCR0KF7SJP_1QITTCSQIOPJSCI7APGAG_H_
...
#define SELF BpSUw8mfEcWf02DHxFXcAEfeiSinvo2iyOrm4KEfBRvnHy4jMGnM6au_0nCr0kf7SJp_1QitTcsqIopJSCi7aPgAg
...
public:
    ...
    SELF() : Tuple(), text_(), isFinal_(), confidence_(), audioTimestamp_() {}
    SELF(const Self & ot) : Tuple(), text_(ot.text_), isFinal_(ot.isFinal_), confidence_(ot.confidence_), audioTimestamp_(ot.audioTimestamp_) 
      { constructPayload(ot); }
    SELF(const text_type & _text, const isFinal_type & _isFinal, const confidence_type & _confidence, const audioTimestamp_type & _audioTimestamp) : Tuple(), text_(_text), isFinal_(_isFinal), confidence_(_confidence), audioTimestamp_(_audioTimestamp) { }
    ...
    {
        buf << text_ << isFinal_ << confidence_ << audioTimestamp_;
    }
    ...
    {
        size_t size = sizeof(SPL::boolean)+sizeof(SPL::float64)+sizeof(SPL::uint64);
...
#undef SELF
#endif // BPSUW8MFECWF02DHXFXCAEFEISINVO2IYORM4KEFBRVNHY4JMGNM6AU_0NCR0KF7SJP_1QITTCSQIOPJSCI7APGAG_H_ 
