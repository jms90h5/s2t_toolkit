...
#include "BpSUw8mfEcWf02DHxFXcAEfeiSinvo2iyOrm4KEfBRvnHy4jMGnM6au_0nCr0kf7SJp_1QitTcsqIopJSCi7aPgAg.h"
#include <sstream>
...
{
    instantiators_.insert(std::make_pair("tuple<rstring text,boolean isFinal,float64 confidence,uint64 audioTimestamp>",&initer));
