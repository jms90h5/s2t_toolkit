...
#ifndef BOA4DOIVUBIAMH24J4OFOOWBTYW_1L9R53TR_1DARFVBZVRKAQAIPWVQDQJHC7MFE_0QSTIWFARO2B5PAWFPHLXQDB_H_
#define BOA4DOIVUBIAMH24J4OFOOWBTYW_1L9R53TR_1DARFVBZVRKAQAIPWVQDQJHC7MFE_0QSTIWFARO2B5PAWFPHLXQDB_H_
...
#define SELF Boa4dOIvUbIAmH24J4ofOOwbtyW_1L9R53Tr_1DArFVbZvrKaQaIPwvqDQjHc7MFE_0QstIWFaRo2B5PaWfPHLxQDb
...
public:
    ...
    typedef SPL::rstring websocketUrl_type;

    enum { num_attributes = 1 } ;
    
    SELF() : Tuple(), websocketUrl_() {}
    SELF(const Self & ot) : Tuple(), websocketUrl_(ot.websocketUrl_) 
      { constructPayload(ot); }
    SELF(const websocketUrl_type & _websocketUrl) : Tuple(), websocketUrl_(_websocketUrl) { }
    ...
    websocketUrl_type & get_websocketUrl() { return websocketUrl_; }
    const websocketUrl_type & get_websocketUrl() const { return websocketUrl_; }
    void set_websocketUrl(const websocketUrl_type & _websocketUrl) { websocketUrl_ = _websocketUrl; }
    ...
    {
        size_t s = 17;
        s = 37 * s + std::hash<websocketUrl_type >()(websocketUrl_);
        return s;
    }
    ...
    {
        size_t size = 0;
           size += websocketUrl_.getSerializedSize();
    ...
    { 
        websocketUrl_ = ot.websocketUrl_; 
        assignPayload(ot);
        return *this; 
    }
    ...
    void swap(SELF & ot) 
    { 
        std::swap(websocketUrl_, ot.websocketUrl_);
...
private:
    ...
    websocketUrl_type websocketUrl_;
...
#undef SELF
#endif // BOA4DOIVUBIAMH24J4OFOOWBTYW_1L9R53TR_1DARFVBZVRKAQAIPWVQDQJHC7MFE_0QSTIWFARO2B5PAWFPHLXQDB_H_ 
