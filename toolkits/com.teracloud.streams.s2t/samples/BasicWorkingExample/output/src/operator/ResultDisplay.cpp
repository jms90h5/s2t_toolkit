// JvXr7xEh0NixOLdO0CCgEzfqAuzNKEGFpCPXZQzTHEmxzoZg4iyPQkRGSISGFrKK0NW1khfUwMhVgwMcZXGTBn
...
{
    ::SPL::Functions::Utility::printStringLn(((((((lit$6 + iport$0.get_text()) + lit$5) + (iport$0.get_isFinal() ? lit$4 : lit$3)) + lit$2) + ::SPL::spl_cast<SPL::rstring, SPL::float64 >::cast((iport$0.get_confidence() * lit$1))) + lit$0));
}
