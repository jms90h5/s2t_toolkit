// zI2khz_04fDMzWjKFh8SnwdVEo_0SQjFQEmZZmlAfvclCYdp0IqUGfRDKajOEahvo2F80q_1hzmPa0I7aRzaLa4CX


#include "./CompletionMonitor.h"
...
#define MY_BASE_OPERATOR CompletionMonitor_Base
#define MY_OPERATOR CompletionMonitor$OP
...
bool MY_BASE_OPERATOR::globalIniter() {
    instantiators_.insert(std::make_pair("CompletionMonitor",&initer));
    return true;
}
...
{
    state$resultCount++;
    if ((state$resultCount >= lit$0)) 
        {
            ::SPL::Functions::Utility::printStringLn(lit$1);
            ::SPL::Functions::Utility::printStringLn(lit$2);
            ::SPL::Functions::Utility::printStringLn(lit$3);
            ::SPL::Functions::Utility::printStringLn(lit$4);
