// 7X_0FL9SH8fTPtCxUE7oHNuWfU0A3kKK0JrQAym59S_16LOAjTv4QAVuv_0gY3nC2z2TSj3o3T1lw7NisCX3C17DY
/*
...
void MY_OPERATOR_SCOPE::MY_OPERATOR::initialize() {
    ...
    try {
        ...
        config_.num_threads = SPL::int32(1);
...
MY_BASE_OPERATOR::MY_BASE_OPERATOR()
 : Operator()  {
    ...
    param$numThreads$0 = SPL::int32(1);
