...
#ifndef SPL_OPER_INSTANCE_TRANSCRIPTIONSTREAM_TRANSCRIPTIONSTREAM_H_
#define SPL_OPER_INSTANCE_TRANSCRIPTIONSTREAM_TRANSCRIPTIONSTREAM_H_
...
protected:
    ...
    SPL::int32 param$chunkSize$0;
    SPL::int32 param$nbest$0;
...
#undef MY_OPERATOR
#endif // SPL_OPER_INSTANCE_TRANSCRIPTIONSTREAM_TRANSCRIPTIONSTREAM_H_
