...
sub main::generate($$) {
   ...
   print '#include "../../impl/include/OnnxSTTWrapper.hpp"', "\n";
   ...
   print '    ', "\n";
   print '    // Configuration', "\n";
   print '    onnx_stt::OnnxSTTWrapper::Config config_;', "\n";
   print '    ', "\n";
   print '    // ONNX-based implementation', "\n";
   print '    std::unique_ptr<onnx_stt::OnnxSTTWrapper> onnx_impl_;', "\n";
   print '    ', "\n";
   ...
   print '    void submitResult(const onnx_stt::OnnxSTTWrapper::TranscriptionResult& result);', "\n";
   print '};', "\n";
   print "\n";
