...
sub main::generate($$) {
   ...
   print '        onnx_impl_ = std::make_unique<onnx_stt::OnnxSTTWrapper>(config_);', "\n";
   print '        ', "\n";
   print '        // Initialize', "\n";
   ...
   print '}', "\n";
   print "\n";
   print 'void MY_OPERATOR_SCOPE::MY_OPERATOR::submitResult(const onnx_stt::OnnxSTTWrapper::TranscriptionResult& result) {', "\n";
