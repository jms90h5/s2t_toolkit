...
sub main::generate($$) {
   ...
   print '// Additional includes for WenetSTT operator', "\n";
   print '#include "../../impl/include/WenetSTTWrapper.hpp"', "\n";
   ...
   print '    ', "\n";
   print '    // Configuration', "\n";
   print '    wenet_streams::WenetSTTWrapper::Config config_;', "\n";
   print '    ', "\n";
   print '    // WeNet-based implementation', "\n";
   print '    std::unique_ptr<wenet_streams::WenetSTTWrapper> wenet_impl_;', "\n";
   print '    ', "\n";
   ...
   print '    void submitResult(const wenet_streams::WenetSTTWrapper::TranscriptionResult& result);', "\n";
   print '};', "\n";
   print "\n";
