class Conv1d(Module):
  ...
  def forward(self: __torch__.torch.nn.modules.conv.___torch_mangle_3.Conv1d,
    input: Tensor) -> Tensor:
    _0 = (self)._conv_forward(input, self.weight, self.bias, )
    return _0
  def _conv_forward(self: __torch__.torch.nn.modules.conv.___torch_mangle_3.Conv1d,
    input: Tensor,
    weight: Tensor,
